...
import Paypal from "@/components/vertical/paypal"
import Stripe from "@/components/vertical/stripe"
import Razorpay from "@/components/vertical/razorpay"
                                ...
                                <div className="col-md-9">
                                    <div className="tab-content" id="v-pills-tabContent">
                                        <div className={`tab-pane fade ${activeTab === 'v-pills-home' ? 'show active' : ''}`}
                                            id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab"><Paypal />
                                            </div>
